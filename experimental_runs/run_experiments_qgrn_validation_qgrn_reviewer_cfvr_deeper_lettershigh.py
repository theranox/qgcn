...
def check_dataset_split_exists_else_download(dataset_split: dict, selected_dataset_config: dict):  
    ...
    if not os.path.exists(full_filepath):
        try:
            ...
            if selected_dataset_config.get("image_to_graph_supported", False): return True
...
dataset_mapping = {
    ...
    #     "sgcn_hidden_size": 7,
    #     # Dataset loc
    #     "image_to_graph_supported": True, # Specifies whether there's ability to support image tensor to torch geo data conversion
...
datasets = {
    'standard':   [
        ...
        # {"train": 50000, "test": 10000, "batch_size": 32},
        # {"train": 60000, "test": 10000, "batch_size": 32}
    ],
    'custom':   [
        # -> All dataset splits
        # {"train": 100, "test": 20, "batch_size": 16},
    ...
    for dataset_group in dataset_groups:
        for dataset_split in datasets[dataset_group]: # loop over datasets
            ...
            for selected_dataset, selected_dataset_config in dataset_mapping.items():
                ...
                experiment_name = f"BATCH-RESULTS-ALL-DATASETS-{selected_dataset.capitalize()}_QGRN_Deeper_Reviewer_cfvR_Summary"
                ...
                for i, lr in enumerate(lrs[dataset_group]): # loop over learning rates
                    ...
                    for run in range(num_runs): # loop over num runs
                        ...
                        # qrgn model
                        qrgn_model = QGRN(out_dim=out_dim,
                        ...
                        experiment = Experiment(sgcn_model = None, # sgcn_model,
                                                qgcn_model = qrgn_model,
                                                cnn_model = None,
