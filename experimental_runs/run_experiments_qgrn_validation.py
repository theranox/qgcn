...
dataset_mapping = {
    ...
    #         - train_2000_test_500
    #         - train_3400_test_900
    "mutagenicity_no_pos_num_layers_3i": {
        "dataset_group": 'custom',
    ...
    #         - train_2000_test_500
    #         - train_3400_test_900
    "mutagenicity_no_pos_num_layers_5i": {
        "dataset_group": 'custom',
        "dataset_name": "mutagenicity",
        "layers_num": 5,
        "out_dim": 2, # num_classes
    ...
    #         - train_2000_test_500
    #         - train_3400_test_900
    "mutagenicity_no_pos_num_layers_7i": {
        "dataset_group": 'custom',
        "dataset_name": "mutagenicity",
        "layers_num": 7,
        "out_dim": 2, # num_classes
    ...
    #         - train_2000_test_500
    #         - train_3400_test_900
    "mutagenicity_no_pos_num_layers_9i": {
        "dataset_group": 'custom',
        "dataset_name": "mutagenicity",
        "layers_num": 9,
        "out_dim": 2, # num_classes
    ...
    #         - train_2000_test_500
    #         - train_3400_test_900
    "mutagenicity_no_pos_num_layers_12i": {
        "dataset_group": 'custom',
        "dataset_name": "mutagenicity",
        "layers_num": 12,
        "out_dim": 2, # num_classes
    ...
    #     "layers_num": 3,
    #     "out_dim": 2, # num_classes
    #     "num_sub_kernels": 5, # 7, # <= max_node_degree
    #     "in_channels": 3, # node_features
    #     "hidden_channels": 32,
    #     "out_channels": 64,
    #     "pos_descr_dim": -1,
...
datasets = {
    ...
    'custom':   [
        ...
        # {"train": 480, "test": 120, "batch_size": 64},
        # {"train": 500, "test": 100, "batch_size": 64},
        # {"train": 850, "test": 250, "batch_size": 16},
        # {"train": 1000, "test": 100, "batch_size": 64},
        # {"train": 1000, "test": 200, "batch_size": 64},
        # {"train": 1050, "test": 150, "batch_size": 64},
        # {"train": 1600, "test": 400, "batch_size": 64},
        ...
        # {"train": 1000, "test": 100, "batch_size": 16},
        # {"train": 1600, "test": 400, "batch_size": 16},
    ...
    for dataset_group in dataset_groups:
        for dataset_split in datasets[dataset_group]: # loop over datasets
            ...
            for selected_dataset, selected_dataset_config in dataset_mapping.items():
                ...
                experiment_name = f"BATCH-RESULTS-ALL-DATASETS-{selected_dataset.capitalize()}_GCN_QGRN_Summary"
